                         ...
                         gboolean copy)
{
    ...
    if(!data || !len) {
        ...
        if(copy) {
            switch (type)
            {
                case SAMPLE_DISPLAY_DATA_INT8: typesize = sizeof(gint8); break;
                case SAMPLE_DISPLAY_DATA_INT16: typesize = sizeof(gint16); break;
                case SAMPLE_DISPLAY_DATA_FLOAT: typesize = sizeof(gfloat); break;
            }
